...
outfile = open("./results/Spermatophyta58024_plnDB_pyphlawd02172020_reformated.csv", "w")
outfile.write("ID,Taxon,Authority,Rank\n")

outfile2 = open("./results/Spermatophyta58024_plnDB_pyphlawd02172020_cultivar.csv", "w")
outfile2.write("ID,Taxon,Rank\n")

outfile3 = open("./results/Spermatophyta58024_plnDB_pyphlawd02172020_ill.hybrids.csv", "w")
outfile3.write("ID,Taxon,Rank\n")

outfile4 = open("./results/Spermatophyta58024_plnDB_pyphlawd02172020_sp.csv", "w")
...
#            try:
#                if common_N(qqbit, spbits) >1:
#                    print("Exceptional case in Line 196:\n"+Line+"\n")
#            except:
#                continue
